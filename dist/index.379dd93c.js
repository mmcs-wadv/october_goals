...
function onDashboardButtonClicked() {
    const mainArea = document.getElementById("main-area");
    const dashboard = new _dashboardDefault.default(mainArea);
    dashboard.build();
}
...
class Dashboard {
    ...
    build() {
        const goalComponent = new _moneyGoalDefault.default();
        const placeholder = new _placeholderDefault.default();
...
},{}],"hrIWY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class MoneyGoal {
    constructor(){
...
exports.default = MoneyGoal;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dJW7P":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Placeholder {
    constructor(){
